%Automobilfederung - Creating the model for the LinearRegression 
% Syntax: Automobilfederung
% Outputs:
%    Creating a model of the automotive suspension
%
% Example: 
%    Automobilfederung
%
%ans = 
%
%  Automobilfederung with properties:
%
%        c1: []
%        c2: []
%        d2: []
            ...
            % ========= YOUR CODE HERE =========
             obj.A = [0 1 0  0;
                      -(obj.c2/obj.m2) -(obj.d2/obj.m2) (obj.c2/obj.m2) (obj.d2/obj.m2);
                       0 0 0 1;
                       (obj.c2/obj.m1) (obj.d2/obj.m1) -((obj.c2+obj.c1)/obj.m1) -(obj.d2/obj.m1)];
        end
        function calcInputMatixB(obj)
            % ========= YOUR CODE HERE =========
             obj.B = [0; 0; 0; (obj.c1 / obj.m1)]; % 1/4 
        end
